...
object SQLdf {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df = spark.read
      ...
      .load("/Users/bhargavichennupati/Downloads/untitled2/survey.csv")


    //df.show()

    df.write.format("csv").option("header","true").save("/Users/bhargavichennupati/Downloads/untitled2/output")
    ...
    val lines = sc.textFile("/Users/bhargavichennupati/Downloads/untitled2/survey.csv")
